...
const Button = __webpack_require__(54);
...
class DataEntry extends React.Component {
  ...
  render() {
    return React.createElement(
      'div',
      { className: 'row-fluid margin-left-large' },
      React.createElement(
        'div',
        { className: 'large-4 columns md-text-field with-floating-label' },
        React.createElement('input', { type: 'text', placeholder: 'Northwestern Mutual Message Board' }),
        React.createElement('div', { onKeyUp: (event => {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'large-4 columns md-text-field' },
            React.createElement('input', { type: 'text', placeholder: 'Update Name', value: this.state.name, onChange: this.handleUsernameChange, required: true })
          ),
          React.createElement(
            'div',
            { className: 'large-4 columns md-text-field with-floating-label' },
            React.createElement('input', { type: 'text', placeholder: 'Update Message Text', value: this.state.text, onChange: this.handleTextChange, required: true })
          ),
          React.createElement(
            'div',
            { className: 'large-4 columns md-text-field with-floating-label' },
            React.createElement('input', { type: 'text', placeholder: 'Enter ID to Delete', value: this.state.id, onChange: this.deleteMessage, required: true })
          )
        )
      ),
      React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'button',
          { className: 'active margin-left-medium' },
          'Get'
        ),
        React.createElement(
          'button',
          { className: 'active margin-left-medium', onClick: this.saveMessage },
          'Put(edit) '
        ),
        React.createElement(
          'button',
        ...
        React.createElement(
          'button',
          { className: 'active margin-left-medium', onClick: () => {
